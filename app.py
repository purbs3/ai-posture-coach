import os
# यह लाइन MediaPipe को C++ के बजाय Python मोड में चलाती है (सबसे बड़ा फिक्स)
...
# ---------- MEDIAPIPE को सबसे सुरक्षित तरीके से इम्पोर्ट करें ----------
# यह 'mp.solutions' वाली एरर को हमेशा के लिए खत्म कर देता है
from mediapipe.python.solutions import pose as mp_pose
from mediapipe.python.solutions import drawing_utils as mp_drawing

# ------------------ PAGE CONFIG (पेज सेटिंग) ------------------
...
# ------------------ SIDEBAR INSTRUCTIONS (साइडबार निर्देश) ------------------
with st.sidebar:
...
# ------------------ ANGLE CALCULATION FUNCTION (कोण निकालने का फंक्शन) ------------------
...
class PoseProcessor(VideoTransformerBase):
    ...
    def transform(self, frame):
        ...
        # अगर शरीर मिल गया तो प्रोसेस करें
        if results.pose_landmarks:
            landmarks = results.pose_landmarks.landmark
            
            try:
                # ----- बाएं हिस्से के अंक (Landmarks) -----
                ...
                # ----- दाहिने हिस्से के अंक (Landmarks) -----
                ...
                # ----- स्क्रीन पर एंगल और फीडबैक दिखाएं -----
                ...
                # ----- शरीर पर स्केलेटन (हड्डियां) बनाएं -----
